...
- [ ] **1. Load and Prepare Data** 
    ...
    - [ ] Implement image resizing (112x112x3) and bounding box scaling.
    - [ ] **Report:** Explain resizing methodology and box transformations.
- [ ] **4. Evaluate Performance** 
    - [ ] Calculate mAP by varying objectness threshold (0 to 1).
    - [ ] Generate Confusion Matrix for the best threshold.
    - [ ] **Report:** Discuss performance differences (Train vs. Val vs. Test.
...
- [ ] **2. Develop the Architecture** 
    - [ ] Build the 1M parameter YOLOv1-style model with the specific 5-block structure .
    - [ ] Implement the 343-neuron sigmoid output layer.
    - [ ] **Report:** Provide architecture summary and motivate activation/pooling choices.
- [ ] **3. Train the Model** 
    - [ ] Implement the **five YOLOv1 loss components** and their weights.
    - [ ] Set up training loop with Early Stopping.
    - [ ] **Report:** Document hyperparameters and generate loss component graphs.
...
- [ ] **Choice 1: Improve Architecture** 
    - [ ] Motivate and implement impactful changes (e.g., deeper layers, different kernels).
